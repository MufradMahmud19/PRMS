...
class Visit(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'doctor': self.doctor.username if self.doctor else None
        }
...
class Prescription(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'doctor': self.prescribing_doctor.username if self.prescribing_doctor else None,
            'visit_date': self.visit.visit_date.isoformat() if self.visit else None
        }
